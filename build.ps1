...
& java -jar swagger-codegen-cli-2.4.14.jar generate -i https://api.cloudmersive.com/swagger/api/nlpv2 -l ruby -o client -c packageconfig.json
...
(Get-Content ./client/cloudmersive-nlp-api-client.gemspec).replace('`find *`.split("\n").uniq.sort.select{|f| !f.empty? }', "Dir['./**/*']") | Set-Content ./client/cloudmersive-nlp-api-client.gemspec
#& npm build ./client
