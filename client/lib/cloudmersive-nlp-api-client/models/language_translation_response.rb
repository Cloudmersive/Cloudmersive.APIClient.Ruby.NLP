...
module CloudmersiveNlpApiClient
  ...
  class LanguageTranslationResponse
    ...
    attr_accessor :translated_text_result
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'TranslatedTextResult')
        self.translated_text_result = attributes[:'TranslatedTextResult']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          translated_text_result == o.translated_text_result &&
    ...
    def hash
      [successful, translated_text_result, sentence_count].hash
    end
