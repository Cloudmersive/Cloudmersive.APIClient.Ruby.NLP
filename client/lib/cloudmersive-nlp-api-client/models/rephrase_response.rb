...
module CloudmersiveNlpApiClient
  ...
  class RephraseResponse
    ...
    attr_accessor :rephrased_results
    ...
    def self.swagger_types
      {
        :'successful' => :'BOOLEAN',
        :'rephrased_results' => :'Array<RephrasedSentence>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'RephrasedResults')
        if (value = attributes[:'RephrasedResults']).is_a?(Array)
          self.rephrased_results = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rephrased_results == o.rephrased_results &&
    ...
    def hash
      [successful, rephrased_results, sentence_count].hash
    end
