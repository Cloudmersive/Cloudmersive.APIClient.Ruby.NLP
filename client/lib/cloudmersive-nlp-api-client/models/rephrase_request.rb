...
module CloudmersiveNlpApiClient
  ...
  class RephraseRequest
    # Text to rephrase
    attr_accessor :text_to_translate
    ...
    def self.swagger_types
      {
        ...
        :'target_rephrasing_count' => :'Integer'
      }
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          text_to_translate == o.text_to_translate &&
          target_rephrasing_count == o.target_rephrasing_count
    end
    ...
    def hash
      [text_to_translate, target_rephrasing_count].hash
    end
